...
The character feature was made with anima's natural language prompting in mind, but can still be used on any other model. It can also now be disabled if you don't want to use it.

currently known issues:
*The automatic (embedded) for the vae sometimes works, but it mostly doesn't work so just select the vae manually.
